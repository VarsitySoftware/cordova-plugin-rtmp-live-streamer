...
- (void)setVideoState:(int)videoState {
    ...
    [self willChangeValueForKey:@"video state"];
    _videoState = videoState;
    [self didChangeValueForKey:@"video state"];
	self.videoCaptureSource.videoState = _videoState;
	//self.videoCaptureSource.paused = _paused;
    //self.audioCaptureSource.paused = _paused;	
}

//- (void)setVideoSize{
	//self.videoCaptureSource.videoWidth = self.videoWidth;
	//self.videoCaptureSource.videoHeight = self.videoHeight;
//}
